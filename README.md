...
| **Extending it** — agents, macros, a chain behind the room | [Developer Guide](Developer_Guide.md) · [scripts/qos-cli](scripts/qos-cli/README.md) | [MacRhoLang](MacRhoLang.md) · [docs/rholang.md](docs/rholang.md) · [scripts/localnet](scripts/localnet/README.md) · **[docs/testnet.md](docs/testnet.md)** (the live testnet: users, then maintainers) · [CLAUDE.md](CLAUDE.md) (the per-feature module map) |
